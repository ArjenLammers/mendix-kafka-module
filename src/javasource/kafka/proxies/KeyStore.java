...
public class KeyStore extends system.proxies.FileDocument
{
	 ...
	 */
	public static final java.lang.String entityName = "Kafka.KeyStore";
	...
	{
		return new kafka.proxies.KeyStore(context, mendixObject);
	}

	public static kafka.proxies.KeyStore load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
	 ...
	 */
	public final void setServer_TrustStore(kafka.proxies.Server server_truststore)
	{
	 ...
	 */
	public final void setServer_KeyStore(kafka.proxies.Server server_keystore)
	{
